...
sst = xr.open_dataset(f"{fp}input_data/MODEL.SST.HAD187001-198110.OI198111-202206.nc")["SST"]
...
sst = sst.where(sst > -1.799, np.nan)
print(np.nanmin(sst))
#save
...
#%%
#this code makes a netcdf for each depth horizon where at all depths => 100m the array will be 100
#and repeats for depths up to 1500
